...
const SUBJECT_COLORS = {
    ...
    'Educación Cívica': 'var(--clr-civica)',
    'Matemática': 'var(--clr-math)',
    'Matemática FAE': 'var(--clr-math)',
    'Ciencias': 'var(--clr-science)',
    'Inglés': 'var(--clr-english)',
    'Francés': 'var(--clr-chemistry)',
    'Educación Musical': 'var(--clr-music)',
    'Artes Plásticas': 'var(--clr-arts)',
    'Educación Religiosa': 'var(--clr-religion)',
    'Educación Física': 'var(--clr-pe)',
    'Artes Industriales': 'var(--clr-comp)',
    'Vida Cotidiana': 'var(--clr-science)',
    'Orientación': 'var(--clr-physics)',
    'Guía': 'var(--clr-guia)',
    'Formación Tecnológica': 'var(--clr-comp)',
    'LIBRE': 'var(--clr-libre)',
};

// English subjects (for motivational phrases)
const ENGLISH_SUBJECTS = ['Inglés'];
...
const SCHEDULE = {
    1: [ // LUNES
        { lesson: 1, start: '7:00', end: '7:40', subject: 'Formación Tecnológica', teacher: 'Verónica Monge Zamora', room: '2', type: 'class' },
        { lesson: 2, start: '7:40', end: '8:20', subject: 'Formación Tecnológica', teacher: 'Verónica Monge Zamora', room: '2', type: 'class' },
        { start: '8:20', end: '8:35', subject: 'Receso', teacher: '', type: 'break', label: 'RECESO · 15 min' },
        { lesson: 3, start: '8:35', end: '9:15', subject: 'Español', teacher: 'Xinia Ávila Castro', room: '9', type: 'class' },
        { lesson: 4, start: '9:15', end: '9:55', subject: 'Español', teacher: 'Xinia Ávila Castro', room: '9', type: 'class' },
        { start: '9:55', end: '10:05', subject: 'Receso', teacher: '', type: 'break', label: 'RECESO · 10 min' },
        { lesson: 5, start: '10:05', end: '10:45', subject: 'Artes Plásticas', teacher: 'Ileana Delgado Segura', room: 'Artes Plást.', type: 'class' },
        { lesson: 6, start: '10:45', end: '11:25', subject: 'Artes Plásticas', teacher: 'Ileana Delgado Segura', room: 'Artes Plást.', type: 'class' },
        { start: '11:25', end: '12:05', subject: 'Almuerzo', teacher: '', type: 'lunch', label: 'ALMUERZO · 40 min' },
        { lesson: 7, start: '12:05', end: '12:45', subject: 'Matemática', teacher: 'Yuliana Calvo Arroyo', room: '16', type: 'class' },
        { lesson: 8, start: '12:45', end: '13:25', subject: 'Guía', teacher: 'Yuliana Calvo Arroyo', room: '16', type: 'class' },
    ],
    2: [ // MARTES
        { lesson: 1, start: '7:00', end: '7:40', subject: 'Ciencias', teacher: 'Cinthia Jiménez Aguilera', room: '25', type: 'class' },
        { lesson: 2, start: '7:40', end: '8:20', subject: 'Ciencias', teacher: 'Cinthia Jiménez Aguilera', room: '25', type: 'class' },
        { start: '8:20', end: '8:35', subject: 'Receso', teacher: '', type: 'break', label: 'RECESO · 15 min' },
        { lesson: 3, start: '8:35', end: '9:15', subject: 'Español', teacher: 'Xinia Ávila Castro', room: '9', type: 'class' },
        { lesson: 4, start: '9:15', end: '9:55', subject: 'Español', teacher: 'Xinia Ávila Castro', room: '9', type: 'class' },
        { start: '9:55', end: '10:05', subject: 'Receso', teacher: '', type: 'break', label: 'RECESO · 10 min' },
        { lesson: 5, start: '10:05', end: '10:45', subject: 'Educación Musical', teacher: 'Andrés Pérez Chaves', room: '1', type: 'class' },
        { lesson: 6, start: '10:45', end: '11:25', subject: 'Educación Musical', teacher: 'Andrés Pérez Chaves', room: '1', type: 'class' },
        { start: '11:25', end: '12:05', subject: 'Almuerzo', teacher: '', type: 'lunch', label: 'ALMUERZO · 40 min' },
        { lesson: 7, start: '12:05', end: '12:45', subject: 'Educación Física', teacher: 'Wilser B.-Andrea A.', room: 'Gimnasio', type: 'class' },
        { lesson: 8, start: '12:45', end: '13:25', subject: 'Educación Física', teacher: 'Wilser B.-Andrea A.', room: 'Gimnasio', type: 'class' },
    ],
    3: [ // MIÉRCOLES
        { lesson: 1, start: '7:00', end: '7:40', subject: 'Francés', teacher: 'Crisy Monge Vargas', room: '8', type: 'class' },
        { lesson: 2, start: '7:40', end: '8:20', subject: 'Francés', teacher: 'Crisy Monge Vargas', room: '8', type: 'class' },
        { start: '8:20', end: '8:35', subject: 'Receso', teacher: '', type: 'break', label: 'RECESO · 15 min' },
        { lesson: 3, start: '8:35', end: '9:15', subject: 'Español', teacher: 'Xinia Ávila Castro', room: '9', type: 'class' },
        { lesson: 4, start: '9:15', end: '9:55', subject: 'Inglés', teacher: 'Karen Sampson Delgado', room: '7', type: 'class' },
        { start: '9:55', end: '10:05', subject: 'Receso', teacher: '', type: 'break', label: 'RECESO · 10 min' },
        { lesson: 5, start: '10:05', end: '10:45', subject: 'Estudios Sociales', teacher: 'Andrea Salazar Soto', room: '18', type: 'class' },
        { lesson: 6, start: '10:45', end: '11:25', subject: 'Estudios Sociales', teacher: 'Andrea Salazar Soto', room: '18', type: 'class' },
        { start: '11:25', end: '12:05', subject: 'Almuerzo', teacher: '', type: 'lunch', label: 'ALMUERZO · 40 min' },
        { lesson: 7, start: '12:05', end: '12:45', subject: 'Vida Cotidiana', teacher: 'Melissa Campos Ramírez', room: '10', type: 'class' },
        { lesson: 8, start: '12:45', end: '13:25', subject: 'Artes Industriales', teacher: 'Karina Novoa Bejarano', room: '11', type: 'class' },
        { start: '13:25', end: '13:30', subject: 'Receso', teacher: '', type: 'break', label: 'RECESO · 5 min' },
        { lesson: 9, start: '13:30', end: '14:10', subject: 'Vida Cotidiana', teacher: 'Melissa Campos Ramírez', room: '10', type: 'class' },
        { lesson: 10, start: '14:10', end: '14:50', subject: 'Orientación', teacher: 'Hugo Arrieta González', room: '19', type: 'class' },
    ],
    4: [ // JUEVES
        { lesson: 1, start: '7:00', end: '7:40', subject: 'Ciencias', teacher: 'Cinthia Jiménez Aguilera', room: '25', type: 'class' },
        { lesson: 2, start: '7:40', end: '8:20', subject: 'Ciencias', teacher: 'Cinthia Jiménez Aguilera', room: '25', type: 'class' },
        { start: '8:20', end: '8:35', subject: 'Receso', teacher: '', type: 'break', label: 'RECESO · 15 min' },
        { lesson: 3, start: '8:35', end: '9:15', subject: 'Ciencias', teacher: 'Cinthia Jiménez Aguilera', room: '25', type: 'class' },
        { lesson: 4, start: '9:15', end: '9:55', subject: 'Francés', teacher: 'Crisy Monge Vargas', room: '8', type: 'class' },
        { start: '9:55', end: '10:05', subject: 'Receso', teacher: '', type: 'break', label: 'RECESO · 10 min' },
        { lesson: 5, start: '10:05', end: '10:45', subject: 'Matemática', teacher: 'Yuliana Calvo Arroyo', room: '16', type: 'class' },
        { lesson: 6, start: '10:45', end: '11:25', subject: 'Matemática', teacher: 'Yuliana Calvo Arroyo', room: '16', type: 'class' },
        { start: '11:25', end: '12:05', subject: 'Almuerzo', teacher: '', type: 'lunch', label: 'ALMUERZO · 40 min' },
        { lesson: 7, start: '12:05', end: '12:45', subject: 'Estudios Sociales', teacher: 'Andrea Salazar Soto', room: '18', type: 'class' },
        { lesson: 8, start: '12:45', end: '13:25', subject: 'Estudios Sociales', teacher: 'Andrea Salazar Soto', room: '18', type: 'class' },
        { start: '13:25', end: '13:30', subject: 'Receso', teacher: '', type: 'break', label: 'RECESO · 5 min' },
        { lesson: 9, start: '13:30', end: '14:10', subject: 'Matemática FAE', teacher: 'Jason Jiménez Chacón', room: '22', type: 'class' },
        { lesson: 10, start: '14:10', end: '14:50', subject: 'Educación Religiosa', teacher: 'Silvia Rodríguez Villalobos', room: '3', type: 'class' },
    ],
    5: [ // VIERNES
        { lesson: 1, start: '7:00', end: '7:40', subject: 'Educación Cívica', teacher: 'Andrea Salazar Soto', room: '18', type: 'class' },
        { lesson: 2, start: '7:40', end: '8:20', subject: 'Educación Cívica', teacher: 'Andrea Salazar Soto', room: '18', type: 'class' },
        { start: '8:20', end: '8:35', subject: 'Receso', teacher: '', type: 'break', label: 'RECESO · 15 min' },
        { lesson: 3, start: '8:35', end: '9:15', subject: 'Inglés', teacher: 'Karen Sampson Delgado', room: '7', type: 'class' },
        { lesson: 4, start: '9:15', end: '9:55', subject: 'Inglés', teacher: 'Karen Sampson Delgado', room: '7', type: 'class' },
        { start: '9:55', end: '10:05', subject: 'Receso', teacher: '', type: 'break', label: 'RECESO · 10 min' },
        { lesson: 5, start: '10:05', end: '10:45', subject: 'Matemática', teacher: 'Yuliana Calvo Arroyo', room: '16', type: 'class' },
        { lesson: 6, start: '10:45', end: '11:25', subject: 'Matemática', teacher: 'Yuliana Calvo Arroyo', room: '16', type: 'class' },
...
function updateHero() {
    ...
    if (todayDow < 1 || todayDow > 5) {
        ...
        if (heroRoom) heroRoom.textContent = '';
    ...
    if (!currentItem) {
        ...
        if (nowMinutes < firstStart) {
            ...
            if (heroRoom) heroRoom.textContent = daySchedule[0].room ? `Aula ${daySchedule[0].room}` : '';
    ...
    if (currentItem.type === 'break' || currentItem.type === 'lunch') {
        ...
        if (heroRoom) heroRoom.textContent = currentItem.room ? `Aula ${currentItem.room}` : '';
    }
            ...
            <div class="${itemClass}">
                ...
                <div class="item-body" onclick="openModal('${noteKey}', '${item.subject.replace(/'/g, "\\\'")}')">
                    ...
                    <div class="item-info">
                        ...
                        <div class="item-teacher">${item.teacher || '—'}${item.room ? ` · Aula ${item.room}` : ''}</div>
                    </div>
...
function renderEvents() {
    ...
    let html = `
        <div class="events-header">
            ...
            <span class="events-subtitle">MEP · Colegio La Aurora</span>
        </div>
        ${headerHtml}
...
const WEATHER_LAT = 10.00;
const WEATHER_LON = -84.12;
